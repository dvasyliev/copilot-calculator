...
This repository contains the Source Code for the "Calculator" from 😈 [GitHub Copilot for Beginners: AI Coding Crash Course](https://linkly.link/2B4WN) course.
...
1. Open repository main [page](https://github.com/dvasyliev/copilot-calculator/).
...
1. Open [commits](https://github.com/dvasyliev/copilot-calculator/commits/main/) page.
